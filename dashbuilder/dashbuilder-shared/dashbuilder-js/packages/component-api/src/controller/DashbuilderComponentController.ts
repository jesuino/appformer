...
export class DashbuilderComponentController implements ComponentController {
  private listener: InternalComponentListener;
  ...
  public setInternalComponentListener(listener: InternalComponentListener) {
  ...
  public callFunction(functionCallRequest: FunctionCallRequest): Promise<any> {
    const props = new Map<MessageProperty, any>();
    props.set(MessageProperty.FUNCTION_CALL_PROP, functionCallRequest);
    this.listener.sendMessage({
