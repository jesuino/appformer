...
public class ExternalComponentAssetProviderImpl implements ExternalComponentAssetProvider {
    ...
    @Override
    public InputStream openAsset(String componentId, String assetPath) throws Exception {
        Path path = Paths.get(componentsLoader.getExternalComponentsDir(), componentId, assetPath);
